...
class ThchsData(Dataset):
    def __init__(self, wav_dir, sample_rate=16000):
        ...
        self.char2id =torch.load('/public/model/data_thchs30/cha2id.pth')
        self.id2char =torch.load('/public/model/data_thchs30/id2char.pth')
...
num_blocks = 3
filters = 128
char2id=torch.load('/public/model/data_thchs30/cha2id.pth')
id2char=torch.load('/public/model/data_thchs30/id2char.pth')
...
st=torch.load('/public/model/data_thchs30/g_0612_0.601')['model']
